...
// todo: remove hardcoded test data and @TabelGenerated ids for UserEntity - those ruin this test
// and there is no need to test Pageable it would be better to test that the result set contains user
